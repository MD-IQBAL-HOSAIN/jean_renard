@extends('backend.layout.app', ['title' => 'System Settings'])
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="text-align: center; font-weight: bold; font-size: 2vw">System Setting</h4>
                        <p class="card-description">Setup your system, please <code>provide your valid
                                data</code>.</p>
                        <div class="mt-4">
                            <form class="forms-sample" method="POST" action="{{ route('system.update', ['id' => $setting->id]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-group row mb-3">
                                    <div class="col">
                                        ...
                                        <input type="email"
                                            ...
                                            placeholder="Email" id="basic-default-system_name" name="system_name"
