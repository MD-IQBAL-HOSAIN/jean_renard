...
@section('main')
    <div class="container content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <h1 class="text-center" style="font-size: 2vw; font-weight: bold; ">Upcomming Album</h1>
                    <hr>
                    <div class="card-body">
                        <div style="display: flex;justify-content: left;"><a href="{{ route('upcomming.album.create') }}"
