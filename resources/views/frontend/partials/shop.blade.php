@extends('frontend.app', ['title' => 'Shop'])
...
<main>
      ...
      <div class="container">
        ...
        <div class="featured-products-container mt_15">
          <a href="product-details.html" class="featured-grid-container">
            <img class="" src="assets/images/featured-product1.jpg" alt="" />
    ...
    <!-- Books By Jean Renard section ends -->

    <!-- Books By Jean Renard section two start -->
    <section class="shop-featured-section">
      <div class="container">
        <div class="featured-text-container">
          <h3 class="shop-h3">Books By Jean Renard</h3>
    ...
    <!-- Books By Jean Renard section two ends -->

    <!-- send notes section starts -->
    <section>
      <div class="send-notes-wrapper">
        <svg class="" xmlns="http://www.w3.org/2000/svg" width="254" height="59" viewBox="0 0 254 59" fill="none">
          <path
