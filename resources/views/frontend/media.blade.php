@extends('frontend.app', ['title' => 'Media'])
...
@section('main')
    ...
    <main>
        ...
        <section>
            <div class="container">
                <div class="sm-biography-trending-wrapper">
                    <a href="#" class="sm-item1">
                        <div class="img1">
                            <img src="assets/images/sm-achievement-01.jpg" alt="">
                        </div>
                        <div class="top-date">
                            <h3>24</h3>
                            <h4>FEB</h4>
                        ...
                        <div class="bottom-text">
                            ...
                            <div class="profile-section">
                                <img class="profile-image" src="assets/images/profile-1.png" alt="">
                                <div>
                                    <h3>Samantha Ryan</h3>
                                    <p>Author, HydroCBD</p>
                                </div>
        ...
        <section>
            <div id="media-video-wrapper" class="video-wrapper-container">
                <div style="background-image: linear-gradient(to bottom, #00000090 50%, #00000090 50%),
            url('assets/images/album-3.png');"
